...
class UpdateUser(BaseModel):
    ...
    password: Optional[SecretStr] = Field(default=None, description="The password (will be hashed before storage).")
    __properties: ClassVar[List[str]] = ["id", "username", "givenName", "familyName", "address", "password"]
